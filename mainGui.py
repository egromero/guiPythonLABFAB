...
class visitsRecords(QMainWindow):
    ...
    def setupUi(self):
        self.lab_id = 1
        self.setStyleSheet("QWidget {background-image: url(images/VisitRecordBG.png)}")
        self.resize(1202, 676)
        self.pushButton_v = QPushButton(self)
        self.pushButton_v.setGeometry(QRect(60,45,250,80))
        self.pushButton_v.setStyleSheet("background :rgba(255,255, 255,30)")
        self.pushButton_v.setObjectName("v")
        self.labelrut = QLabel(self)
        self.labelrut.setGeometry(QRect(170, 163 , 400, 100))
        self.labelrut.setStyleSheet("background :rgba(255,255, 255,30); font: 30pt \"MS Shell Dlg 2\";")
        self.pushButton_7 = QPushButton(self)
        self.pushButton_7.setGeometry(QRect(180, 295, 110, 70))
        self.pushButton_7.setStyleSheet("background :rgba(255,255, 255,30)")
        self.pushButton_7.setObjectName("7")
        self.pushButton_8 = QPushButton(self)
        self.pushButton_8.setGeometry(QRect(330, 295, 110, 70))
        self.pushButton_8.setStyleSheet("background :rgba(255,255, 255,30)")
        self.pushButton_8.setObjectName("8")
        self.pushButton_9 = QPushButton(self)
        self.pushButton_9.setGeometry(QRect(490, 295, 110, 70))
        self.pushButton_9.setStyleSheet("background :rgba(255,255, 255,30)")
        self.pushButton_9.setObjectName("9")
        self.pushButton_4 = QPushButton(self)
        self.pushButton_4.setGeometry(QRect(180, 415, 110, 70))
        self.pushButton_4.setStyleSheet("background :rgba(255,255, 255,30)")
        self.pushButton_4.setObjectName("4")
        self.pushButton_5 = QPushButton(self)
        self.pushButton_5.setGeometry(QRect(330, 415, 110, 70))
        self.pushButton_5.setStyleSheet("background :rgba(255,255, 255,30)")
        self.pushButton_5.setObjectName("5")
        self.pushButton_6 = QPushButton(self)
        self.pushButton_6.setGeometry(QRect(490, 415, 110, 70))
        self.pushButton_6.setStyleSheet("background :rgba(255,255, 255,30)")
        self.pushButton_6.setObjectName("6")
        self.pushButton_1 = QPushButton(self)
        self.pushButton_1.setGeometry(QRect(180, 520, 110, 70))
        self.pushButton_1.setStyleSheet("background :rgba(255,255, 255,30)")
        self.pushButton_1.setObjectName("1")
        self.pushButton_2 = QPushButton(self)
        self.pushButton_2.setGeometry(QRect(330, 520, 110, 70))
        self.pushButton_2.setStyleSheet("background :rgba(255,255, 255,30)")
        self.pushButton_2.setObjectName("2")
        self.pushButton_3 = QPushButton(self)
        self.pushButton_3.setGeometry(QRect(490, 520, 110, 70))
        self.pushButton_3.setStyleSheet("background :rgba(255,255, 255,30)")
        self.pushButton_3.setObjectName("3")
        self.pushButton_k = QPushButton('K',self)
        self.pushButton_k.setGeometry(QRect(180, 630, 110, 70))
        self.pushButton_k.setStyleSheet("background :rgba(255,255, 255,30)")
        self.pushButton_k.setObjectName("k")
        self.pushButton_0 = QPushButton(self)
        self.pushButton_0.setGeometry(QRect(330, 630, 110, 70))
        self.pushButton_0.setStyleSheet("background :rgba(255,255, 255,30)")
        self.pushButton_0.setObjectName("0")
        self.pushButton_d = QPushButton(self)
        self.pushButton_d.setGeometry(QRect(490, 630, 110, 70))
        self.pushButton_d.setStyleSheet("background :rgba(255,255, 255,30)")
        self.pushButton_d.setObjectName("d")
        self.pushButton_s = QPushButton('Enviar', self)
        self.pushButton_s.setGeometry(QRect(840, 530, 150, 50))
        self.pushButton_s.setStyleSheet("background :rgba(255,255, 255,30)")
        self.pushButton_s.setObjectName("s")
        self.motivo = QLabel(self)
        self.motivo.setGeometry(QRect(750, 85, 300, 61))
        self.motivo.setText('Motivo de visita')
        self.motivo.setStyleSheet("background :rgba(255,255, 255,0); font: 14pt \"MS Shell Dlg 2\"; color: white")
        self.comboBox = QComboBox(self)
        self.comboBox.setGeometry(QRect(750, 195, 311, 61))
        ...
        self.institucion.setGeometry(QRect(750, 300, 300, 61))
        self.institucion.setStyleSheet("background :rgba(255,255, 255,0); font: 14pt \"MS Shell Dlg 2\"; color: white")
        self.institucion.setText('Insititucion que pertenece')
        self.comboBox_1 = QComboBox(self)
        self.comboBox_1.setGeometry(QRect(750, 395, 311, 61))
        self.comboBox_1.setStyleSheet("font: 12pt \"MS Shell Dlg 2\";")
...
class MainWindow(QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.setStyleSheet("QWidget {background-image: url(images/InitialBG.png)}")
        self.lab_id = 1
        self.centralwidget = QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.pushButton = QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QRect(810, 150, 300, 280))
    ...
    def changeScreen(self, dataset):   
        string = "QWidget {background-image: url(%s)}" % (dataset['image'])
