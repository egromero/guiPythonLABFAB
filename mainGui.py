...
class MainWindow(QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.label_4.setGeometry(QRect(400, 30, 510, 61))
    ...
    def changeColor(self, value):
            ...
            # arrayLabs = value['laboratory']
            # for lab in arrayLabs:
            #     if lab['id'] == self.lab_id:
            #         matriculado = True
            # if matriculado:
            #     texto = option[str(type(value))][0]
            #     color = option[str(type(value))][1]
            # else:
            #     texto = option[str(type(value))][2]
            #     color = option[str(type(value))][3]
