...
class NumberPad(QWidget):
    def __init__(self):
        ...
        self.runlabel.setStyleSheet("border: 0.5px solid black; font: 38pt \"MS Shell Dlg 2\";")
        self.grid_layout.addWidget(self.runlabel, 0,1)
        self.grid_layout.addWidget(self.createNumberPad(), 1,1)
        ...
        self.grid_layout.addWidget(buttomspace, 2,0)
        self.showFullScreen()
